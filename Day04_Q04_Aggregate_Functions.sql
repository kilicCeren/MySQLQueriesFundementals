...
-- bu urun nedir  denseydi
SELECT urun_adi AS en_ucuz_urun , birim_fiyati AS en_ucuz_urun_fiyati
FROM satis_raporu
WHERE birim_fiyati = (SELECT MIN(birim_fiyati) FROM satis_raporu);
...
-- bu urun nedir kac tane satilmis

SELECT urun_adi AS satis_miktari_en_fazla_olan_urun ,satis_miktari AS satis_miktari_en_fazla_olan_urun_sayisi
FROM satis_raporu
WHERE satis_miktari =(SELECT MAX(satis_miktari) FROM satis_raporu);
